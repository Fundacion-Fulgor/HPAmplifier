...
# Paths
# =========================================================
BASE_PATH = Path("./runs/OTA_Telescopic_TOP_TB_StartUp100n_io")
...
for corner_dir in sorted(corner_base.iterdir()):
    ...
    for sim in sim_types:
        ...
        try:
            vdd = pd.read_csv(
                sim_corner_dir / "VDD_100ns_DC_io.txt",
                sep=r"\s+",
                header=None,
                skiprows=1,
                names=["time", "VDD"]
            ...
            idd = pd.read_csv(
                sim_corner_dir / "IDD_100ns_DC_io.txt",
                sep=r"\s+",
                header=None,
                skiprows=1,
                names=["time", "IDD"]
            ...
            vcm = pd.read_csv(
                sim_corner_dir / "VCM_100ns_DC_io.txt",
                sep=r"\s+",
                header=None,
                skiprows=1,
                names=["time", "VCM"]
...
axs[0].set_title("StartUp TR_VDD = 100ns")
axs[0].grid(True)
