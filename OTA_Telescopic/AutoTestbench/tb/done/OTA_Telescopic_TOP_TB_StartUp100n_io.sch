...
wrdata VCM_100ns_DC_io.txt VCM
wrdata IDD_100ns_DC_io.txt IDD
wrdata VDD_100ns_DC_io.txt VDD
...
.endc
"}
C {code_shown.sym} -410 -420 0 0 {name=s1 only_toplevel=false value=".inc ../../../../../Layout_and_Related_files/pex/OTA_Telescopic_TOP_wp.spice"}
