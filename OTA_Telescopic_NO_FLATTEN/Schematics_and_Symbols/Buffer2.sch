...
N -440 50 -440 60 {lab=#net1}
N -220 -160 -220 -70 {lab=vm}
N -220 -10 -220 20 {lab=#net2}
N -220 20 -90 20 {lab=#net2}
N -90 20 -90 60 {lab=#net2}
N -90 20 30 20 {lab=#net2}
N 30 -10 30 20 {lab=#net2}
N 30 -120 30 -70 {lab=VOUT}
...
N 30 -120 250 -120 {lab=VOUT}
N 30 -190 30 -120 {lab=VOUT}
N -290 -40 -260 -40 {lab=VIN}
N 250 -40 330 -40 {lab=VOUT}
N -440 50 -360 50 {lab=#net1}
N -360 50 -360 90 {lab=#net1}
N -400 90 -360 90 {lab=#net1}
N -440 160 -90 160 {lab=VSS}
N -450 160 -440 160 {lab=VSS}
N -80 90 -80 160 {lab=VSS}
N -90 160 -80 160 {lab=VSS}
N -520 160 -450 160 {lab=VSS}
N -440 -300 -230 -300 {lab=VDD}
N 70 -40 250 -40 {lab=VOUT}
N 250 -120 250 -40 {lab=VOUT}
N -440 -20 -440 50 {lab=#net1}
N -440 -300 -440 -80 {lab=VDD}
N -500 -300 -440 -300 {lab=VDD}
N -530 -170 -520 -170 {lab=IB}
