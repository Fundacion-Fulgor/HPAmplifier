...
N -945 105 -945 165 {lab=IOVDD}
N -945 225 -945 240 {lab=GND}
N 20 -110 20 -100 {lab=Vout1}
N 20 -100 560 -100 {lab=Vout1}
N 20 -80 20 -70 {lab=Vout2}
N 20 -80 360 -80 {lab=Vout2}
N -330 -50 -330 50 {lab=VN}
N -560 -130 -180 -130 {lab=VP}
...
"
spice_ignore=true}
C {lab_wire.sym} -335 -130 0 0 {name=p7 sig_type=std_logic lab=VP}
C {lab_wire.sym} -310 -50 0 0 {name=p8 sig_type=std_logic lab=VN}
...
C {lab_wire.sym} -140 10 1 1 {name=p2 sig_type=std_logic lab=VREF}
C {lab_wire.sym} -80 -170 0 1 {name=p3 sig_type=std_logic lab=VDD}
...
spice_ignore=short}
C {ihpIC.sym} -100 -90 0 0 {name=x1}
C {gnd.sym} -110 -10 0 0 {name=l6 lab=GND}
C {vsource.sym} -945 195 0 0 {name=V4 value=1.8 savecurrent=false}
C {lab_wire.sym} -945 105 0 0 {name=p5 sig_type=std_logic lab=IOVDD}
C {gnd.sym} -945 240 0 0 {name=l8 lab=GND}
C {lab_wire.sym} -110 -170 0 0 {name=p9 sig_type=std_logic lab=IOVDD}
C {code_shown.sym} -885 -380 0 0 {name=s1 only_toplevel=false value=".inc ../../Schematics_and_Symbols/ihpIC.spice"}
C {code_shown.sym} -900 -490 0 0 {name=IOCells models only_toplevel=false value="
